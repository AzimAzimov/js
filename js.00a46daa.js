...
},{}],"js/_banner.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initBanner = void 0;
...
const initBanner = () => {
  ...
  //     for (let index = 0; index < animItems.length; index++) {
  //       const animItem = animItems[index];
  //       const animItemHeight = animItem.offsetHeighth;
  //       const animItemOffset = offset(animItem).top;
  //       const animStart = 4;
  //       let animItemPoint = window.innerHeight - animItemHeight / animStart;
  //       if (animItemHeight > window.innerHeight) {
  ...
  //         animItem.classList.add('active');
  //       } else {
  //         if (!animOnScroll.classList.contains('.anim__no__hide')) {
  //           animItem.classList.remove('active');
  //         }
  //       }
  //     }
...
},{}],"js/_paralax.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initParalax = void 0;

const initParalax = () => {
  const firstLink = document.querySelector('.paralax__menu-link');
  const arrow = document.querySelector('.arrow');
  const subMenu = document.querySelector('.paralax__submenu-list');
  const twoLink = document.querySelector('.two__link');
  const twoArrow = document.querySelector('.paralax__submenu-arrow');
  const twoMenu = document.querySelector('.paralax__bottom-menu');
  firstLink.addEventListener('click', () => {
    arrow.classList.toggle('active');
    subMenu.classList.toggle('active');
    firstLink.classList.toggle('active');
  });
  twoLink.addEventListener('click', () => {
    firstLink.classList.toggle('active');
    twoArrow.classList.toggle('active');
    twoMenu.classList.toggle('active');
  });
};

exports.initParalax = initParalax;
...
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"js/libs/slick.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initSlick = void 0;
...
const teamSlider = (0, _jquery.default)('.team__members-wrapper.slick'); // vacanciesSlide = $('.vacancies__images-row'),
...
exports.initSlick = initSlick;
},{"jquery":"../node_modules/jquery/dist/jquery.js","slick-carousel/slick/slick":"../node_modules/slick-carousel/slick/slick.js"}],"js/_tabs.js":[function(require,module,exports) {
"use strict";
...
const initTabs = () => {
  document.querySelectorAll('.tabs__link').forEach(elem => {
    elem.addEventListener('click', function (e) {
      e.preventDefault();
      const id = e.target.getAttribute('href').replace('#', '');
      document.querySelectorAll('.tabs__link').forEach(element => element.classList.remove('active'));
      document.querySelectorAll('.tabs__body').forEach(el => el.classList.add('hide'));
...
},{}],"js/_forms.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initForms = void 0;
...
var _banner = require("./_banner");

var _paralax = require("./_paralax");

var _slick = require("./libs/slick");
...
(function () {
  ...
  try {
    ...
    (0, _banner.initBanner)();
    (0, _paralax.initParalax)();
    (0, _tabs.initTabs)();
    (0, _forms.initForms)();
    (0, _popup.initPopup)();
    (0, _slick.initSlick)(); // initHelpers();
  } catch (err) {
    console.log(err);
  }
})();
},{"./_header":"js/_header.js","./_banner":"js/_banner.js","./_paralax":"js/_paralax.js","./libs/slick":"js/libs/slick.js","./_tabs":"js/_tabs.js","./_forms":"js/_forms.js","./_popup":"js/_popup.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
